...
Various version of `umap-learn` take different parameters as input. The R package is coded to work with `umap-learn` versions 0.2.3 and 0.3.0. Note, however, that some arguments that are acceptable in 0.3.0 are not explicitly set in the default configuration object. 
